...
async def _merge_edges_then_upsert(
    ...
    if await knowledge_graph_inst.has_edge(src_id, tgt_id, namespace=namespace):
        already_edge = await knowledge_graph_inst.get_edge(src_id, tgt_id, namespace=namespace)
